...
/obj/item/xenoarch/strange_rock/attackby(obj/item/attacking_item, mob/living/user, params)
	...
	if(istype(attacking_item, /obj/item/xenoarch/brush))
		...
		playsound(src, pick('modular_zzvenus/sound/effects/scrubbing/scrubbing1.ogg','modular_zzvenus/sound/effects/scrubbing/scrubbing2.ogg'), 50, FALSE, frequency = clamp(50 / (xeno_brush.dig_speed * skill_modifier), 0.33, 3)) //VENUS ADDITION - Sound for brushing
